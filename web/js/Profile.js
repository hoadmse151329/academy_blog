$(document).ready(function () {
    ...
    var deleteButton = document.getElementById("blogContent");
    $.ajax({
        ...
        success: function (result) {
            ...
            if (returnedData && returnedData.length > 0) {
                for (i = 0; i < returnedData.length; i++) {
                    ...
                    blog.innerHTML = "<div class='avatar-box'> <div class='avatar-pic'> <a href='page-single-user.html' ><img src='images/single-topic-img01.jpg' alt='' /></a> </div> <div class='avatar-name'> <div class='name'> <a href='page-single-user.html'>" + returnedData[i].authorId + "</a> </div> <div class='date-up'><span>" + returnedData[i].createdDate + "</span></div> </div> </div> <div class='title-box'><a href='#' class='detail-link'><h2>" + returnedData[i].title + "</h2></a><ul> <li><a href='#'>#Tag</a></li> <li><a href='#'>#Tag</a></li> <li><a href='#'>#Tag</a></li> <li><a href='#'>#Tag</a></li> </ul> <span>Comment:0</span><br></br><button type='submit' class='btn-edit-del'><img src='images/pencil-1466_96e96df4-f387-42f9-b404-031c18f324b8.png' alt=''></button> <button type='submit' class='btn-edit-del delete'><img src='images/shopping-basket-2200_9917ac3f-3ab2-41a0-87fa-99d6c6d5fddb.png' alt=''></button></div>";

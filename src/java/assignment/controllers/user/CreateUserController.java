package assignment.controllers.user;
...
import assignment.user.CreateUserErrorDTO;
...
public class CreateUserController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean check = true;
            CreateUserErrorDTO userError = new CreateUserErrorDTO();
            ...
            if (check) {
                ...
                UserDTO user = new UserDTO(userID, password, fullName, email, avatar, createDate, isActive, roleID);
